...
import com.Precious.PreciousHotel.dto.UserDTO;
...
import com.Precious.PreciousHotel.utils.JWTUtils;
...
public class UserService implements IUserService {
    ...
    public Response getAllUsers() {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error in getting all users" + e.getMessage());
    ...
    public Response getUserBookingHistory(String userId) {
        ...
        response.setStatusCode(500);
        response.setMessage("Error in getting user booking history" + e.getMessage());
    ...
    public Response deleteUser(String userId) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error in deleting a user" + e.getMessage());
